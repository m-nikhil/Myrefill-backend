...
export class FeedbackCreation1603617303057 implements MigrationInterface {
  name = 'FeedbackCreation1603617303057';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "feedback" ADD CONSTRAINT "FK_4bd4c7a1fd97604df4f65f5123e" FOREIGN KEY ("transactionId") REFERENCES "transaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
