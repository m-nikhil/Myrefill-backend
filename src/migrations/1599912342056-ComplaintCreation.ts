...
export class ComplaintCreation1599912342056 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "complaint" ADD CONSTRAINT "FK_5795e32a6ad50aee5c720864fa6" FOREIGN KEY ("stationId") REFERENCES "station"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "complaint" ADD CONSTRAINT "FK_52dc113dcddfae564f99848c8af" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "complaint" DROP CONSTRAINT "FK_52dc113dcddfae564f99848c8af"`,
    );
    await queryRunner.query(
      `ALTER TABLE "complaint" DROP CONSTRAINT "FK_5795e32a6ad50aee5c720864fa6"`,
    );
